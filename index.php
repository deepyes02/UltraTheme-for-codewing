...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri();?>/css/fontawesome-all.css">
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri();?>/css/raratheme-companion-public.css">
			...
			<div class="container">
				...
				<div class="site-branding logo-text">
					...
					<div class="site-text-wrap">
						<h1 class="site-title">
							<a href="index.html" title="Super Ultra Theme"><?php echo get_bloginfo('title');?></a>
						</h1>
